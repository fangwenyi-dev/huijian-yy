...
class WindowControllerDeviceManager:
    ...
    def _get_optimal_concurrent_tasks(self):
        ...
        try:
            ...
            # 使用 run_in_executor 来执行阻塞的 psutil 调用
