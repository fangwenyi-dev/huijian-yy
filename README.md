...
| 意图名称 | 说明 | 示例语音 |
|---------|------|---------|
| `TurnDeviceOn` | 打开各类窗户 | "打开客厅窗户"、"打开平开窗"、"打开推拉窗" |
| `TurnDeviceOff` | 关闭各类窗户 | "关闭卧室窗户"、"关闭天窗" |
| `AdjustDeviceAttribute` | 调节窗户位置 | "窗帘开50%" |
| `ControlWindow` | 控制平推窗特殊操作 | "打开平推窗"、"关闭平推窗"、"平推窗暂停" |
