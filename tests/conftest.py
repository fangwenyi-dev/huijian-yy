...
# bleak_esphome
_bleak_esphome_mock = MagicMock()
_bleak_esphome_mock.connect_scanner = MagicMock()
sys.modules["bleak_esphome"] = _bleak_esphome_mock
...
ha_entity.Entity.__init__ = lambda self, **kw: None
ha_entity.EntityCategory = type("EntityCategory", (), {"CONFIG": "config", "DIAGNOSTIC": "diagnostic"})
ha_entity.async_setup_entities = MagicMock()
...
ha_entity_platform.async_get_current_platform = MagicMock()
ha_entity_platform.EntityPlatform = MagicMock()
...
ha_bluetooth.async_remove_scanner = MagicMock()
ha_bluetooth.async_get_scanner = MagicMock()
ha_bluetooth.async_rediscover_address = MagicMock()
ha_bluetooth.FallbackBluetoothProvider = MagicMock()
ha_bluetooth.BluetoothServiceInfoBleak = MagicMock()
ha_bluetooth.BluetoothServiceInfo = MagicMock()
ha_bluetooth._async_register_scanner = AsyncMock()
ha_bluetooth.async_get_advertisement_callback = MagicMock()
ha_bluetooth.BaseHaScanner = type("BaseHaScanner", (), {})
ha_bluetooth.BaseBluetoothCoordinator = type("BaseBluetoothCoordinator", (), {})
ha_bluetooth.BluetoothScanningMode = type("BluetoothScanningMode", (), {"ACTIVE": "active", "PASSIVE": "passive"})
ha_bluetooth.BluetoothCallback = type("BluetoothCallback", (), {})
ha_bluetooth.BluetoothChange = type("BluetoothChange", (), {})
