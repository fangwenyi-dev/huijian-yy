...
| 意图名称 | 说明 | 示例语音 |
|---------|------|---------|
| `TurnDeviceOn` | 打开各类窗户 | "打开卧室窗户"、"打开平开窗"、"打开推拉窗" |
| `TurnDeviceOff` | 关闭各类窗户 | "关闭客厅窗户"、"关闭天窗"、"关闭窗户" |
| `AdjustDeviceAttribute` | 调节窗户位置 | "窗帘开50%"、"窗户关一半" |
| `ControlWindow` | 控制平推窗 | "打开平推窗"、"关闭平推窗"、"平推窗暂停" |

**支持的窗户类型：** 平开窗、推拉窗、平推窗、天窗、内开窗、外开窗、内开内倒窗、飘窗等
