...
class OptionsFlowHandler(OptionsFlowWithReload):
    ...
    async def async_step_init(
        ...
        return self.async_show_menu(
            step_id="init",
            menu_options=["voice_scenes_manage", "options"],
            description_placeholders={
                "manage_url": "/huijian-ai/voice-scenes/manage",
            }
        )

    async def async_step_voice_scenes_manage(
        self, user_input: dict[str, Any] | None = None
    ) -> ConfigFlowResult:
        """Redirect to voice scenes management."""
        return self.async_external_step(
            step_id="voice_scenes_manage",
